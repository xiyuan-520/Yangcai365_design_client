 ...
 */
public class DesignAfterComplainReturnResponse extends YangcaiClientResponse
{
    //写参数字段
    private boolean        isReturned;//                                          是否已取消
    protected void buildResponse(String json)
    {
        setReturned(Jsons.getBoolean(json, "isReturned"));
    }
