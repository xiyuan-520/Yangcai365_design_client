 ...
 */
public class DesignAfterComplainReturnRequest extends YangcaiClientRequest<DesignAfterComplainReturnResponse>
{
    //       字段类型                   接口字段              长度             是否必须           字段描述
    private long                     merchantId;//                            是               商户标号
    private long                    designAfsId;//            64               是               第三方售后单号
    private String                     returnNote;//           300               是               问题描述
    public String getMethod()
    {
        return AFTER_COMPLAIN_RETURN;
    }

    public DesignAfterComplainReturnResponse newResponse()
    {
        return new DesignAfterComplainReturnResponse();
    }
    ...
    protected void buildQueryBody()
    {
        ...
        addParam("returnNote", returnNote);
    }
